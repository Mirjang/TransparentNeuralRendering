...
export RENDERER_TYPE=PerPixel2_1
...
# #experiment name
export NAME=${MODEL}_${RENDERER_TYPE}_${DATA}_tex${TEX_DIM}x${TEX_FEATURES}_L1VGG_noex
# additional options 
export OPTIONS="--ngf 128 "
