...
# #experiment name
export NAME=${MODEL}_${RENDERER_TYPE}_${DATA}_tex${TEX_DIM}x${TEX_FEATURES}_L1VGG_nopad
# additional options 
export OPTIONS="--use_extrinsics --ngf 256"

# continue training an existing model
export CONTINUE="--lossType all --suspend_gan_epochs 25 --lambda_L1 100 --lambda_VGG 50 --niter_decay 2000 --continue_train" # --continue_train --epoch_count 216"