...
# #experiment name
export NAME=${MODEL}_${RENDERER_TYPE}_${DATA}_tex${TEX_DIM}x${TEX_FEATURES}_L1VGG_PAD
# additional options 
export OPTIONS="--ngf 256 --use_extrinsics --pad_front"

# continue training an existing model
export CONTINUE="--weight_decay 1e-4 --lossType all --suspend_gan_epochs 25 --lambda_L1 100 ----lambda_VGG 100 --niter_decay 2000" # --continue_train --epoch_count 10" --target_downsample_factor 2